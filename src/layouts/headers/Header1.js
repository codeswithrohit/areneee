...
import { FaUser,FaSignInAlt, FaShoppingCart } from "react-icons/fa"; // Import the cart icon
                  ...
                  <div className="absolute -right-8 z-30  w-64 bg-white rounded-md shadow-lg hidden group-hover:block">
                    <ul>
                      <li className="border-b hover:bg-gray-100">
                        <Link href="#">
                          <a className="block px-4  font-bold py-2 text-gray-800">Sign in</a>
                        </Link>
                      </li>
                   
                      <li className="border-b hover:bg-gray-100">
                        <Link href="/signin">
                          <a className="block px-4 py-2 text-xs font-bold text-gray-900">Sign in as User</a>
                        </Link>
                      </li>
                   
                      <li className="border-b hover:bg-gray-100">
                        <Link href="/Deliveryboy/loginregister">
                          <a className="block px-4 py-2 text-xs font-bold text-gray-800">Sign in as Delivery Boy</a>
                        </Link>
                      </li>
                   
                      <li className="border-b hover:bg-gray-100">
                        <Link href="/AreneChefVendor/loginregister">
                          <a className="block px-4 py-2 text-xs font-bold text-gray-800">Sign in as Arene Chef Vendor</a>
                        </Link>
                      </li>
                   
                      <li className="border-b hover:bg-gray-100">
                        <Link href="/ArenelaundryVendor/loginregister">
                          <a className="block px-4 py-2 text-xs font-bold text-gray-800">Sign in as Arene laundry Vendor</a>
                        </Link>
                      </li>
