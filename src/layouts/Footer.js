    ...
    <div>
      ...
      <ul class="grid max-sm:grid-cols-1 max-lg:grid-cols-2 lg:grid-cols-4 gap-12 mt-20">
        <li class="flex items-center">
          ...
          <a href="javascript:void(0)" class="text-white font-mono text-sm ml-3">
            <small class="block">Tel</small>
            <strong>+91 9999789352</strong>
          </a>
        </li>
        <li class="flex items-center">
          <div class="bg-gray-900 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
          ...
          <a href="javascript:void(0)" class="text-white font-mono text-sm ml-3">
            ...
            <strong>support@areneservices.in</strong>
          </a>
        </li>
        <li class="flex items-center">
          <div class="bg-gray-900 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
      ...
      <div class="flex max-md:flex-col gap-4">
        <ul class="flex flex-wrap gap-4">
          <li class="text-sm">
            <a href='/about' class='text-white font-mono font-semibold hover:underline'>About Us</a>
          </li>
          <li class="text-sm">
            <a href='/tandc' class='text-white font-mono font-semibold hover:underline'>Terms & Condition</a>
          </li>
          <li class="text-sm">
            <a href='/privacypolicy' class='text-white font-mono font-semibold hover:underline'>Privacy Policy</a>
          </li>
        </ul>
        <p class='text-sm text-gray-200 md:ml-auto font-mono'>Copyright © 2024<a href='https://areneservices.in/'
          target='_blank' class="hover:underline mx-1 font-mono">ARENE SERVICES</a>All Rights Reserved.</p>
      </div>
    </footer>
    </div>
  )
