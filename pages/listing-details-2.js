          ...
          <div className="w-full md:w-[800px] bg-white shadow-lg rounded-lg overflow-hidden">
            ...
            <div className="p-4">
              ...
              <div className="mt-4 grid grid-cols-2 gap-4">
                ...
                <div>
                  <p className="font-semibold">Market Distance from Property:</p>
                  <p>{Buydetaildata.market} KM </p>
                </div>
                <div>
                  <p className="font-semibold">Park Distance from Property:</p>
                  <p>{Buydetaildata.park} KM </p>
                </div>
                <div>
                  <p className="font-semibold">Metro Distance from Property:</p>
                  <p>{Buydetaildata.metro} KM </p>
                </div>
                <div>
                  <p className="font-semibold">Hospital Distance from Property:</p>
                  <p>{Buydetaildata.hospital} KM </p>
                </div>
                <div>
                  <p className="font-semibold">School Distance from Property:</p>
                  <p>{Buydetaildata.school} KM </p>
                </div>
              </div>
