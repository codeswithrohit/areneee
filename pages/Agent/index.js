...
const Ourhistory = () => {
        ...
        try {
            ...
            if (userDocSnap.exists()) {
                ...
                if (userData.isVendor) {
                    ...
                    router.push('/signin'); // Redirect to the login page if the user is not an admin
                }
            } else {
    ...
    return (
        <div className='min-h-screen' >
            <AgentNav />
            <section className=" container px-4 md:px-24 lg:py-4 py-4 mt-2 md:py-4 font-mono">
